...
module "ocean-aws-k8s-vng" {
  ...
  instance_types_filters_enable            = var.instance_types_filters_enable
  ...
  scheduling_shutdown_hours                = var.scheduling_shutdown_hours
  scheduling_task                          = var.scheduling_task
}
